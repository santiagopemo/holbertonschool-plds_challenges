...
class Fighter(BaseChampion):
    ...
    init_stats = {"health": 1000, "attack": 20, "defense": 20, "magic": 2, "speed": 15}

    def __init__(self, name, raze, gender, level, nv_exp, current_exp, total_exp, stat_points):
        
        super().__init__(name, raze, gender, level, nv_exp, current_exp, total_exp, type(self).init_stats.copy(), stat_points)
